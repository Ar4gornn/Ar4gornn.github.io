...
const projects = [
  ...
  },
  {
    ...
    highlights: [
      ...
      "API key required on every write; the app refuses to start without one",
      "63 tests, most against real SQLite rather than the in-memory provider",
    ],
    screenshot: null,
    demo: null,
  },
